...
class PenaltykatalogPrinter implements Printer {
    ...
    final class PrintActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            PrintManager.print(getPrintable(), I18n.get("PenaltyCatalog"), true, controller.getWindow());
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            PrintManager.preview(controller.getWindow(), pc, I18n.get("PenaltyCatalog"), IconManager.getIconBundle(), IconManager.getTitleImages());
        }
    }
}