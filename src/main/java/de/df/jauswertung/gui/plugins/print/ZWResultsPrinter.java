...
class ZWResultsPrinter implements Printer {
    ...
    void printResults(boolean[][] selection) {
        PrintManager.print(getPrintable(selection), I18n.get("ZWResults"), true, controller.getWindow());
    }
    ...
    void previewResults(boolean[][] selection) {
        PrintManager.preview(controller.getWindow(), new PPrintableCreator(selection), I18n.get("ZWResults"), IconManager.getIconBundle(),
