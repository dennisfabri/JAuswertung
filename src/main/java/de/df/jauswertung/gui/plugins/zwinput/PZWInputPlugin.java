...
public class PZWInputPlugin extends ANullPlugin {
    ...
    ZWDataProvider              barcodeprovider = null;
    ...
    void initPanel() {
        ...
        barcode = new JZWBarcodeInputPanel(this, controller, core, http);

        barcodeprovider = new ZWDataProvider(barcode, http);

        http.registerDataProvider(barcodeprovider);

        input1 = new JGlassPanel<JPanel>(simple);
        input1.setName(INPUT1);
        input1.setEnabled(false);

        input2 = new JGlassPanel<JPanel>(barcode);
