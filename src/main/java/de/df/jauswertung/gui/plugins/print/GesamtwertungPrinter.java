...
class GesamtwertungPrinter implements Printer {
    ...
    final class PrintActionListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent arg0) {
            PrintManager.print(getPrintable(), I18n.get("GroupEvaluation"), true, controller.getWindow());
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            PrintManager.preview(controller.getWindow(), pc, I18n.get("GroupEvaluation"), IconManager.getIconBundle(), IconManager.getTitleImages());
        }
    }
}