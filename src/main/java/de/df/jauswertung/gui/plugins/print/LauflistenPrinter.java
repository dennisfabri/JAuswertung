...
class LauflistenPrinter implements Printer {
    ...
    final class PrintActionListener implements ActionListener {
        ...
        <T extends ASchwimmer> void printLaufliste(OWSelection[] t) {
            ...
            PrintManager.print(getPrintable((AWettkampf<ASchwimmer>[]) wkx.toArray(new AWettkampf[wkx.size()])), I18n.get("Laufliste"), true,
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (wk.isHeatBased()) {
                ...
                PrintManager.print(getPrintable(), I18n.get("Laufliste"), true, controller.getWindow());
            }
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (wk.isHeatBased()) {
                ISimpleCallback<OWSelection[]> cb = new ISimpleCallback<OWSelection[]>() {
                    ...
                    public void callback(OWSelection[] t) {
                        if (t != null) {
                            ...
                            PrintManager.preview(controller.getWindow(), new PPrintableCreator(wkx.toArray(new AWettkampf[wkx.size()])), I18n.get("Laufliste"),
                ...
                PrintManager.preview(controller.getWindow(), new PPrintableCreator(new AWettkampf[] { wk }), I18n.get("Laufliste"), IconManager.getIconBundle(),
