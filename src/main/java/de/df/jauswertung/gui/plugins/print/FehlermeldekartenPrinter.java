...
class FehlermeldekartenPrinter implements Printer {
    ...
    final class EmptyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            PrintManager.print(getPrintable(), I18n.get("Fehlermeldekarten"), true, controller.getWindow());
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            PrintManager.preview(controller.getWindow(), pc, I18n.get("Fehlermeldekarten"), IconManager.getIconBundle(), IconManager.getTitleImages());
        }
    }
}