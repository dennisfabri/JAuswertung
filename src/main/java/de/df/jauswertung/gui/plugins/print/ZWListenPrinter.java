...
class ZWListenPrinter implements Printer {
    ...
    final class PrintActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            PrintManager.print(getPrintable(), I18n.get("ZWList"), true, controller.getWindow());
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent arg0) {
            PrintManager.preview(controller.getWindow(), new PPrintableCreator(), I18n.get("ZWList"), IconManager.getIconBundle(),
