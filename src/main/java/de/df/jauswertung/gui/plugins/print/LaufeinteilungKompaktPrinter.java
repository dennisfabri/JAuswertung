...
class LaufeinteilungKompaktPrinter implements Printer {
     ...
     */
    void print() {
        PrintManager.print(getPrintable(), I18n.get("HeatarrangementCompact"), controller.getWindow());
    }
    ...
    void preview() {
        ...
        PrintManager.preview(controller.getWindow(), pc, I18n.get("HeatarrangementCompact"), IconManager.getIconBundle(), IconManager.getTitleImages());
    }
