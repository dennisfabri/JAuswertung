...
abstract class AFilledKartenPrinter implements Printer {
    ...
    final class PrintActionListener implements ActionListener {
        ...
        <T extends ASchwimmer> void printLaufliste(OWSelection[] t) {
            ...
            if (askForDetails(wk)) {
                PrintManager.print(getPrintable(wk), text, true, controller.getWindow());
            }
        }
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (wk.isHeatBased()) {
                ...
                if (askForDetails(wk)) {
                    PrintManager.print(getPrintable(new AWettkampf[] { wk }), text, true, controller.getWindow());
                }
            }
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (wk.isHeatBased()) {
                    ...
                    public void callback(OWSelection[] t) {
                        if (t != null) {
                            ...
                            if (askForDetails(wkx)) {
                                PrintManager.preview(controller.getWindow(), new PPrintableCreator(wkx), text, IconManager.getIconBundle(),
                ...
                if (askForDetails(wk)) {
                    PrintManager.preview(controller.getWindow(), new PPrintableCreator(new AWettkampf[] { wk }), text, IconManager.getIconBundle(),
                            IconManager.getTitleImages());
                }
            }
        }
