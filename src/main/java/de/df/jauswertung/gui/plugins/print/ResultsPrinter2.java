...
class ResultsPrinter2 implements Printer {
    ...
    void printResults(boolean[][] selection) {
        PrintManager.print(getPrintable(selection), I18n.get("Results"), true, controller.getWindow());
    }
    ...
    void previewResults(boolean[][] selection) {
        PrintManager.preview(controller.getWindow(), new PPrintableCreator(selection), I18n.get("Results"), IconManager.getIconBundle(),
