...
public class MImportExportPlugin extends ANullPlugin {
    ...
    SelectOrganisationPlugin       selectOrganisation = null;
    ...
    public void setController(IPluginManager c, String uid) {
        ...
        try {
            ...
            // Plugin has not been loaded - Nothing serious
        }
    ...
    synchronized JExportWizard getExportWizard() {
        if (exportWizard == null) {
            ...
            if (selectOrganisation != null) {
                orga = selectOrganisation.getSelectedOrganisation();
            }
            exportWizard = new JExportWizard(getController().getWindow(), core, bugreport, mode, orga);
        }
        return exportWizard;
    }
