...
public class DM03EOffenmTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm03/einzel-akoffenm.txt";
    ...
    public DM03EOffenmTest(String x) {
        super(x);
    }
