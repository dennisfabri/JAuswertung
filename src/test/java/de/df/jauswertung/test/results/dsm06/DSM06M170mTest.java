...
public class DSM06M170mTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dsm06/mannschaft-ak170m.csv";
    private static final boolean MALE = true;
    private static final int     AK   = 8;

    public DSM06M170mTest(String x) {
        super(x);
    }
