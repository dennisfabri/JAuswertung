...
public class DM1999E12wTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm1999/einzel-ak12w.txt";
    ...
    public DM1999E12wTest(String x) {
        super(x);
    }
