...
public class DSM06M170wTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dsm06/mannschaft-ak170w.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 8;

    public DSM06M170wTest(String x) {
        super(x);
    }
