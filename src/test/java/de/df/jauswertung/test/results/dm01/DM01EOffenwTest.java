...
public class DM01EOffenwTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm01/einzel-akoffenw.txt";
    ...
    public DM01EOffenwTest(String x) {
        super(x);
    }
