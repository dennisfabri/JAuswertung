...
public class DM06MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm06/mannschaft-akoffenw.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM06MOffenwTest(String x) {
        super(x);
    }
