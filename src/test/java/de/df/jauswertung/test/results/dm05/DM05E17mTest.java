...
public class DM05E17mTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm05/einzel-ak17m.csv";
