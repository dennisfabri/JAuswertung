...
public class DM00EOffenwTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm00/einzel-akoffenw.txt";
    ...
    public DM00EOffenwTest(String x) {
        super(x);
    }
