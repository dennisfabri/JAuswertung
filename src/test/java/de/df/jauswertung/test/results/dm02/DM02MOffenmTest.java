...
public class DM02MOffenmTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm02/mannschaft-akoffenm.txt";
    private static final boolean MALE = true;
    private static final int     AK   = 4;

    public DM02MOffenmTest(String x) {
        super(x);
    }
