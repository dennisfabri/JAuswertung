...
public class DM02M13mTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm02/mannschaft-ak13m.txt";
    private static final boolean MALE = true;
    private static final int     AK   = 1;

    public DM02M13mTest(String x) {
        super(x);
    }
