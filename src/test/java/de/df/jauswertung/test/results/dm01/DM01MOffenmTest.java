...
public class DM01MOffenmTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm01/mannschaft-akoffenm.txt";
    private static final boolean MALE = true;
    private static final int     AK   = 4;

    public DM01MOffenmTest(String x) {
        super(x);
    }
