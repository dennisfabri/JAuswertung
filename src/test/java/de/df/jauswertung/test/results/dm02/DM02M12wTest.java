 ...
 */
package de.df.jauswertung.test.results.dm02;
...
public class DM02M12wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm02/mannschaft-ak12w.txt";
    ...
    protected void setUp() throws Exception {
        if (TestUtils.INDEPENDENT_INITIALIZATION || (wk == null)) {
            ...
            data = MiscImportUtils.importFile(wk, AK, MALE, FILE);
