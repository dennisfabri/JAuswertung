...
public class DM1999E17mTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm1999/einzel-ak17m.txt";
    ...
    public DM1999E17mTest(String x) {
        super(x);
    }
