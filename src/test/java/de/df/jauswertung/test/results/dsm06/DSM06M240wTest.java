...
public class DSM06M240wTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dsm06/mannschaft-ak240w.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 10;

    public DSM06M240wTest(String x) {
        super(x);
    }
