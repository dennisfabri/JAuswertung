...
public class DM03MOffenmTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm03/mannschaft-akoffenm.txt";
    private static final boolean MALE = true;
    private static final int     AK   = 4;

    public DM03MOffenmTest(String x) {
        super(x);
    }
