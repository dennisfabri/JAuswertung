...
public class DM04M17wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm04/mannschaft-ak17w.txt";
