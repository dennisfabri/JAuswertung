...
public class DM06MOffenmTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm06/mannschaft-akoffenm.csv";
    private static final boolean MALE = true;
    private static final int     AK   = 4;

    public DM06MOffenmTest(String x) {
        super(x);
    }
