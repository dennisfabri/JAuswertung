...
public class DM00E17mTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm00/einzel-ak17m.txt";
