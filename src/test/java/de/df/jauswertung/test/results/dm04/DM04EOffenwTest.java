...
public class DM04EOffenwTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm04/einzel-akoffenw.txt";
    ...
    public DM04EOffenwTest(String x) {
        super(x);
    }
