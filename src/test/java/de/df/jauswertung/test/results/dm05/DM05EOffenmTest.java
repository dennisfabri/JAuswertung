...
public class DM05EOffenmTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm05/einzel-akoffenm.csv";
    ...
    public DM05EOffenmTest(String x) {
        super(x);
    }
