...
public class DSM06M140wTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dsm06/mannschaft-ak140w.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 7;

    public DSM06M140wTest(String x) {
        super(x);
    }
