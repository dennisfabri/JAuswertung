...
public class DM01MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm01/mannschaft-akoffenw.txt";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM01MOffenwTest(String x) {
        super(x);
    }
