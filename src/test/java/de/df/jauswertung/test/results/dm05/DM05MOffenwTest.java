...
public class DM05MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm05/mannschaft-akoffenw.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM05MOffenwTest(String x) {
        super(x);
    }
