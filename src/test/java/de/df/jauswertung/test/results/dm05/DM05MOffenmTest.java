...
public class DM05MOffenmTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm05/mannschaft-akoffenm.csv";
    private static final boolean MALE = true;
    private static final int     AK   = 4;

    public DM05MOffenmTest(String x) {
        super(x);
    }
