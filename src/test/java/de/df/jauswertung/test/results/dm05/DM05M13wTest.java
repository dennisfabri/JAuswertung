 ...
 */
package de.df.jauswertung.test.results.dm05;
...
public class DM05M13wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm05/mannschaft-ak13w.csv";
