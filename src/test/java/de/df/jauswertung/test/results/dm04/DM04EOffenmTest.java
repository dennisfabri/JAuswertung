...
public class DM04EOffenmTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm04/einzel-akoffenm.txt";
    ...
    public DM04EOffenmTest(String x) {
        super(x);
    }
