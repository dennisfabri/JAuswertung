...
public class DM1999E15mTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm1999/einzel-ak15m.txt";
    ...
    public DM1999E15mTest(String x) {
        super(x);
    }
