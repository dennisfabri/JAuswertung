 ...
 */
package de.df.jauswertung.test.results.dm03;
...
public class DM03M13wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm03/mannschaft-ak13w.txt";
