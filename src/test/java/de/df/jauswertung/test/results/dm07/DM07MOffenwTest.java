...
public class DM07MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm07/mannschaft-akoffenw.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM07MOffenwTest(String x) {
        super(x);
    }
