...
public class DM04MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm04/mannschaft-akoffenw.txt";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM04MOffenwTest(String x) {
        super(x);
    }
