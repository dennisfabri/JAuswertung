...
public class DM01M15wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm01/mannschaft-ak15w.txt";
