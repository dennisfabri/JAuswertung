...
public class DM02EOffenwTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm02/einzel-akoffenw.txt";
    ...
    public DM02EOffenwTest(String x) {
        super(x);
    }
