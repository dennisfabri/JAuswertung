...
public class DM1999M12wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm1999/mannschaft-ak12w.txt";
    ...
    public DM1999M12wTest(String x) {
        super(x);
    }
