...
public class DM03MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm03/mannschaft-akoffenw.txt";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM03MOffenwTest(String x) {
        super(x);
    }
