...
public class DM00MOffenmTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm00/mannschaft-akoffenm.txt";
    private static final boolean MALE = true;
    private static final int     AK   = 4;

    public DM00MOffenmTest(String x) {
        super(x);
    }
