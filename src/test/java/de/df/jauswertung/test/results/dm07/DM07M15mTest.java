...
public class DM07M15mTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm07/mannschaft-ak15m.csv";
