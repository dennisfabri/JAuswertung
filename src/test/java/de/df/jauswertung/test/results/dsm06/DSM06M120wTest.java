...
public class DSM06M120wTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dsm06/mannschaft-ak120w.csv";
    private static final boolean MALE = false;
    private static final int     AK   = 6;

    public DSM06M120wTest(String x) {
        super(x);
    }
