...
public class DM06EOffenmTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm06/einzel-akoffenm.csv";
    ...
    public DM06EOffenmTest(String x) {
        super(x);
    }
