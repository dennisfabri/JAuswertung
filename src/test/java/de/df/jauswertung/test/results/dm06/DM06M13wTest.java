 ...
 */
package de.df.jauswertung.test.results.dm06;
...
public class DM06M13wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm06/mannschaft-ak13w.csv";
