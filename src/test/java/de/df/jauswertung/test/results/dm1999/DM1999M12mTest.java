...
public class DM1999M12mTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm1999/mannschaft-ak12m.txt";
    ...
    public DM1999M12mTest(String x) {
        super(x);
    }
