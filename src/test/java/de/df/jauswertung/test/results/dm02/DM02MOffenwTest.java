...
public class DM02MOffenwTest extends TestCase {

    private static final String  FILE = "src/test/resources/competitions/dm02/mannschaft-akoffenw.txt";
    private static final boolean MALE = false;
    private static final int     AK   = 4;

    public DM02MOffenwTest(String x) {
        super(x);
    }
