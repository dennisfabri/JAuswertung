...
public class OGeneralOptionsPlugin extends ANullPlugin implements MOptionenPlugin.OptionsPlugin {
    ...
    private HighTimesPlugin highTimes;
    ...
    public void setController(IPluginManager plugincontroller, String pluginuid) {
        ...
        highTimes = (HighTimesPlugin) plugincontroller.getPlugin("de.df.jauswertung.hightimes", pluginuid);
        if (highTimes == null) {
            throw new NullPointerException();
        }
    ...
    public void apply() {
        ...
        highTimes.setEnabled(hightimes);
    }
