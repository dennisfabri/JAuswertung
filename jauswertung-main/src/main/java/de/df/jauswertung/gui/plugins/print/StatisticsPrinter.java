...
class StatisticsPrinter implements Printer {
    ...
    void print() {
        PrintManager.print(getPrintable(), I18n.get("Statistics"), true, controller.getWindow());
    }

    void preview() {
        PrintManager.preview(controller.getWindow(), new MeldelistenPC(), I18n.get("Statistics"), IconManager.getIconBundle(), IconManager.getTitleImages());
    }
