...
class ZieleinlaufkartenPrinter implements Printer {
    ...
    final class EmptyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            PrintManager.print(getPrintable(), I18n.get("Zieleinlaufkarten"), true, controller.getWindow());
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            PrintManager.preview(controller.getWindow(), pc, I18n.get("Zieleinlaufkarten"), IconManager.getIconBundle(), IconManager.getTitleImages());
        }
    }
}