...
public class DM08EOffenmTest extends TestCase {
    ...
    public DM08EOffenmTest(String x) {
        super(x);
    }
    ...
    protected void setUp() throws Exception {
        if (wk == null) {
            ...
            data = TestImportUtils.importFile(wk, FILE, new int[] { 0, 1, 2, 3, 4, 5 });
