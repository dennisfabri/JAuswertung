...
public class JAuswertungReasonChecker implements UpdateEvent.ReasonChecker {
    ...
    public long check(long updatereason) {
        ...
        if ((updatereason & UpdateEventConstants.REASON_NEW_LOAD_WK) > 0) {
            updatereason = updatereason | UpdateEventConstants.REASON_AKS_CHANGED
                    | UpdateEventConstants.REASON_PROPERTIES_CHANGED
                    | UpdateEventConstants.REASON_ZW_LIST_CHANGED | UpdateEventConstants.REASON_LAUF_LIST_CHANGED
                    | UpdateEventConstants.REASON_REFEREES_CHANGED
        ...
        if ((updatereason & UpdateEventConstants.REASON_TEAMASSIGNMENT_CHANGED) > 0) {
            updatereason = updatereason | UpdateEventConstants.REASON_POINTS_CHANGED
