...
public final class SprecherlistePrintable<T extends ASchwimmer> extends ComponentPackingPrintable {
     ...
     * @return
     */
    private static <T extends ASchwimmer> JPanel getTablePanel(Lauf<T> lauf,
                                                               boolean[] lanes,
                                                               boolean showDisciplines,
                                                               boolean showTimes,
                                                               boolean showQuali,
                                                               boolean showNotes,
        ...
        JTable table = new JPrintTable(datas.toArray(new Object[datas.size()][0]), titles);
        if (!showNotes) {
