...
public class DM07EOffenwTest extends TestCase {

    private static EinzelWettkampf               wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm07/einzel-akoffenw.csv";
    ...
    public DM07EOffenwTest(String x) {
        super(x);
    }
