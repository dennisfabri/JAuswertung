...
public class DM07M12wTest extends TestCase {

    private static MannschaftWettkampf           wk      = null;

    private static final String                  FILE    = "src/test/resources/competitions/dm07/mannschaft-ak12w.csv";
    ...
    protected void setUp() throws Exception {
        if (wk == null) {
            ...
            data = TestImportUtils.importFile(wk, FILE, new int[] { 0, 2, 3, 1 });
