...
public class JAKsEditor extends JGlassFrame {
    ...
    boolean doApply() {
        ...
        getSettings(akx);
        if (!akx.isValid()) {
            DialogUtils.warn(this, I18n.get("Title.RulebookValidationerror"), I18n.get("Information.RulebookValidationerror"),
                    I18n.get("Note.RulebookValidationerror"));
            return false;
        }
    ...
    private boolean accept() {
        if (fullAccess) {
            ...
            boolean result = DialogUtils.askAndWarn(this, I18n.get("QuitEditorTitle", I18n.get("RulebookEditor")),
                    I18n.get("QuitEditorText", I18n.get("RulebookEditor")), I18n.get("QuitEditor.Note", I18n.get("RulebookEditor")));
            setEnabled(true);
            return result;
        }
        return true;
    ...
    Printable getPrintable() {
        ...
        getSettings(a);
        editor.getAKs(a);
        return PrintManager.getFinalPrintable(RulebookPrinter.getPrintable(a, true), new Date(), true, I18n.get("Rulebook"));
    }
    ...
    public void setVisible(boolean b) {
        super.setVisible(b);
        if (!b && (callback != null)) {
            SwingUtilities.invokeLater(new Thread("Rulebook - Callback") {
                @Override
                public void run() {
                    callback.callback(JAKsEditor.this);
                }
            });
        }
    }
