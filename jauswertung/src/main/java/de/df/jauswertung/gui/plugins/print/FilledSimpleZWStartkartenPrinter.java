...
class FilledSimpleZWStartkartenPrinter implements Printer {
    ...
    final class PrintActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            if (askForDetails()) {
                PrintManager.print(getPrintable(), I18n.get("FilledZWStartkarten"), true, controller.getWindow());
            }
        }
    }
    ...
    final class PreviewActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            if (askForDetails()) {
                ...
                PrintManager.preview(controller.getWindow(), pc, I18n.get("FilledZWStartkarten"), IconManager.getIconBundle(), IconManager.getTitleImages());
            }
        }
    }
}