...
class JTeammembersBarcodeScanPanel extends JPanel {
    ...
    public JTeammembersBarcodeScanPanel(PTeammembersScanPlugin parent, IPluginManager controller, CorePlugin core, HttpServerPlugin http) {
    ...
    private void ShowDetails(Mannschaft s) {
        ...
        if (details.getComponentCount() == 0) {
            details.setLayout(new FormLayout("0dlu,fill:default,4dlu,fill:default:grow,4dlu,fill:default:grow,4dlu,fill:default,4dlu,fill:default,0dlu",
    ...
    void initPanel() {
        ...
        setLayout(layout);
        add(createOverviewPanel(), CC.xyw(2, 2, 3));
        add(createInputPanel(), CC.xy(2, 4));
        add(createIdPanel(), CC.xy(4, 4));
    ...
    private JPanel createIdPanel() {
        ...
        FormLayout layout = new FormLayout("4dlu,fill:default,4dlu,fill:default:grow,4dlu,fill:default,4dlu", "4dlu,fill:default,4dlu,fill:default,4dlu");
        JPanel top = new JPanel(layout);
