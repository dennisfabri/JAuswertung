...
public class JsonResults {
    private void uploadJson(String attachmentId, AWettkampf<?> wk) {
        try {
            ResultsDto results = new ResultsCreator().createResults(wk);
    ...
    private static class ResultsCreator {
        @FunctionalInterface
        ...
        public <T extends ASchwimmer, X> List<X> createResults(AWettkampf<T> wk, CreateCompetitor<T, X> creator) {
