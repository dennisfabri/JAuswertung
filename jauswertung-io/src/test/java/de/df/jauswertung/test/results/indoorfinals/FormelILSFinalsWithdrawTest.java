...
public class FormelILSFinalsWithdrawTest {
    ...
    private static void trageZeitenEin(EinzelWettkampf wk, OWSelection selection) {
        ...
        SearchUtils.getSchwimmer(wk, 9).getEingabe(selection.getId(), true).addStrafe(Strafe.WITHDRAW);
    }
    ...
    void lauflisteFinale() {
        ...
        assertEquals(10, laufliste.get(0).getSchwimmer(3).getStartnummer());
        assertEquals(11, laufliste.get(0).getSchwimmer(4).getStartnummer());
        assertEquals(12, laufliste.get(0).getSchwimmer(2).getStartnummer());
        assertEquals(13, laufliste.get(0).getSchwimmer(5).getStartnummer());
        assertEquals(14, laufliste.get(0).getSchwimmer(1).getStartnummer());
        assertEquals(15, laufliste.get(0).getSchwimmer(6).getStartnummer());
        assertEquals(16, laufliste.get(0).getSchwimmer(0).getStartnummer());
        assertEquals(17, laufliste.get(0).getSchwimmer(7).getStartnummer());
    }
    ...
    void ergebnisFinale() {
        ...
        for (int x = 0; x < 8; x++) {
            assertEquals(String.format("Teilnehmer, %d", x + 10),
    ...
    void ergebnisGesamt() {
        ...
        assertEquals(String.format("Teilnehmer, %d", 9), ergebnisGesamt.getResult(16).getSchwimmer().getName());

        for (int x = 17; x < AnzahlSchwimmer; x++) {
