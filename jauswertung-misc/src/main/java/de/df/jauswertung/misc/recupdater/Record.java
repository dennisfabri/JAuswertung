...
public class Record implements Serializable {
    ...
    private boolean fitsAgegroup(String ag) {
        if (ag.equalsIgnoreCase("Manikin Relay")) {
            ag = "ak offen";
        }
        if (ag.equalsIgnoreCase("Obstacle Relay")) {
            ag = "ak offen";
        }
        if (ag.equalsIgnoreCase("Medley Relay")) {
            ag = "ak offen";
        }
        if (ag.equalsIgnoreCase("Lifesaving Relay")) {
            ag = "ak offen";
        }
        if (ag.equalsIgnoreCase("Pool Lifesaver Relay")) {
            ag = "ak offen";
        }
        if (ag.equalsIgnoreCase("open")) {
            ag = "ak offen";
        }
        if (ag.equalsIgnoreCase("u19")) {
            ag = "ak 17/18";
        }
        if (ag.equalsIgnoreCase("u17")) {
            ag = "ak 15/16";
        }
    ...
    String[][] matchings = new String[][]{{"50m Retten", "50 m Retten einer Puppe"},
            ...
            {"200m Obstacle Swim", "200 m Hindernisschwimmen"},
            ...
            {"Obstacle Swim", "200 m Hindernisschwimmen"},
            {"Super-Lifesaver", "200 m Super Lifesaver"},
            {"Super Lifesaver", "200 m Super Lifesaver"},
